...
// UpdateEmailVerifiedByEmail provides a mock function with given fields: ctx, email
func (_m *UserRepository) UpdateEmailVerifiedByEmail(ctx context.Context, email string) error {
	ret := _m.Called(ctx, email)
